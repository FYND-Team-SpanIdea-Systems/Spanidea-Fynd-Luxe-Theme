          ...
          <div
            ...
            <transition mode="out-in" name="fade">
              ...
              <template v-else>
                ...
                />
                <video
                  v-if="image.type === 'video' && !image.url.includes('youtube')"
                  :key="image.url"
                  :src="image.url"
                  :srcset="image.srcset || ''"
                  class="vue-lb-modal-image"
                ...
                >
                  <no-ssr>
                    <viewer-3d :src="image.url"></viewer-3d>
                  </no-ssr>
                </div>
              </template>
            </transition>
...
.vue-lb-figure::-webkit-scrollbar { 
    width: 0px;
  }
...
import mobilecarousel from "../mobile-pdp-carousel.vue";
